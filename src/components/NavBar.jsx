  ...
  return (
    <nav className="flex w-full justify-between items-center fixed top-0 z-20">
      <div className="w-full flex justify-between items-center sm:px-16 px-6 py-5 bg-black">
        <p className="font-main text-cream font-bold text-2xl">
          Nathan Van Utrecht
        </p>
        <ul className="hidden sm:flex gap-9 items-center font-main text-light_gold text-lg font-medium">
        ...
        <div className="sm:hidden">
          {!menuVisible ? (
            <IoMenuOutline
              className="text-light_gold text-4xl hover-default"
          ...
          {menuVisible && (
            <div className="absolute top-20 right-0 p-6 mx-4 my-2 bg-gray rounded-xl min-w-[200px]">
              <ul className="flex flex-col gap-4 font-main text-light_gold text-lg font-medium">
                <li className="hover-default">
                  <AnchorLink href="#about">About</AnchorLink>
                </li>
                <li className="hover-default">
